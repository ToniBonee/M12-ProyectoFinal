...
ngOnInit() {
  ...
  menuOptions: { name: string; subOptions: string[] }[] = [
    { name: 'Opción 1', subOptions: ['SubOpción 1.1', 'SubOpción 1.2', 'SubOpción 1.3'] },
    { name: 'Opción 2', subOptions: ['SubOpción 2.1', 'SubOpción 2.2', 'SubOpción 2.3'] },
    { name: 'Opción 3', subOptions: ['SubOpción 3.1', 'SubOpción 3.2', 'SubOpción 3.3'] }
  ];
